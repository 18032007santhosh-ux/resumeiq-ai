          ...
          <div className="max-w-[1400px] mx-auto space-y-8 pb-16">
            ...
            <div className="mt-8">
              <div className="text-center py-16 px-4 border-2 border-dashed border-slate-800 rounded-3xl bg-slate-900/30">
                ...
                <h4 className="text-lg font-semibold text-white mb-2">Settings Coming Soon</h4>
                <p className="text-slate-400 max-w-sm mx-auto">
                  We're working on giving you more control. Settings will be available in the next update.
                </p>
              </div>
            </div>
