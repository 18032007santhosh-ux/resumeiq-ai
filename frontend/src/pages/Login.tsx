      ...
      <div className="auth-content-wrapper">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="auth-input-group">
              <div className="auth-label-wrapper">
                ...
                <Link to="/forgot-password" style={{ fontSize: '0.75rem', color: 'var(--primary-light)', textDecoration: 'underline' }}>Forgot password?</Link>
              </div>
              <div className="auth-input-wrapper">
            ...
            <div className="auth-checkbox-group">
              ...
              />
              <label htmlFor="remember-me" className="auth-checkbox-label">Remember me for 30 days</label>
            </div>
          ...
          <div className="relative" style={{ margin: '1.5rem 0' }}>
            ...
            <div className="relative flex justify-center text-xs uppercase"><span className="bg-slate-900/80 px-3 text-slate-500" style={{ background: '#0e1227' }}>Or continue with</span></div>
          </div>
          ...
          <div className="text-center text-xs text-slate-400" style={{ marginTop: '2rem' }}>
            Don't have an account?{' '}
            <Link to="/register" className="text-indigo-400 hover:underline font-semibold" style={{ color: 'var(--primary-light)' }}>Create Account</Link>
          </div>
        </motion.div>
      </div>
    </div>
