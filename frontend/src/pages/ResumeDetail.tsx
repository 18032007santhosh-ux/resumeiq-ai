...
import { 
  ...
  Clock, User, Mail, Phone, MapPin, Linkedin, Github, Globe,
                  ...
                  <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-2xl p-6 lg:p-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {renderField('LinkedIn', resume.parsedData.linkedin, <Linkedin className="w-5 h-5" />, true)}
                        {renderField('GitHub', resume.parsedData.github, <Github className="w-5 h-5" />, true)}
