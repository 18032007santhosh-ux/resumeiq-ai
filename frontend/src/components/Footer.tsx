  ...
  return (
    <footer className="footer">
      <div className="footer-top">
        <div className="footer-brand">
          ...
          <p className="footer-tagline">
            Intelligent ATS Resume Analyzer & Career Assistant. Bypassing recruiter filters, one resume at a time.
          </p>
        </div>
      ...
      <div className="footer-bottom">
        <p className="copyright">&copy; {new Date().getFullYear()} ResumeIQ AI. All rights reserved.</p>
        <p className="credit" style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>Made by Santhosh ❤️</p>
        <div className="footer-socials">
          ...
          <a href="mailto:support@resumeiq.ai" aria-label="Email support">
            <Mail size={20} />
          </a>
        </div>
      </div>
